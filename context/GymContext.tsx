...
const MOCK_GYMS: Gym[] = [
  {
    ...
    gymDescription: 'State-of-the-art fitness center with modern equipment, personal trainers, and group classes. Perfect for all fitness levels.',
    rating: 4.6,
    images: [
      {
        name: 'Main Gym Area',
    ...
    amenities: ['Air Conditioning', 'Locker Rooms', 'Shower Facilities', 'Parking', 'WiFi'],
    availableStatus: 'Available',
    availableFrom: new Date().toISOString(),
    ageOfGym: 3,
    gymEquipment: ['Treadmills', 'Dumbbells', 'Barbells', 'Cable Machines', 'Smith Machine'],
    facilities: ['Swimming Pool', 'Sauna', 'Steam Room', 'Juice Bar', 'Massage Room'],
    trainerServices: ['Personal Training', 'Group Classes', 'Nutrition Counseling', 'Fitness Assessment'],
    bookingDetails: {
      operationHours: '05:00 AM - 11:00 PM',
      membershipOption: 'Monthly/Quarterly/Annual',
    },
    rules: ['No outside food', 'Proper gym attire required', 'Clean equipment after use', 'No loud music'],
    additionalFeatures: ['24/7 Access', 'Mobile App', 'Diet Plans', 'Progress Tracking'],
    pricing: {
  ...
  },
  {
    ...
    gymDescription: 'Intense CrossFit training facility with certified coaches and competitive atmosphere. Join our fitness community.',
    rating: 4.8,
    images: [
      {
        name: 'CrossFit Area',
    ...
    amenities: ['Specialized Equipment', 'Coaching', 'Community Events', 'Parking'],
    availableStatus: 'Available',
    availableFrom: new Date().toISOString(),
    ageOfGym: 2,
    gymEquipment: ['Olympic Barbells', 'Kettlebells', 'Pull-up Bars', 'Rowing Machines', 'Battle Ropes'],
    facilities: ['Outdoor Training Area', 'Recovery Zone', 'Nutrition Corner'],
    trainerServices: ['CrossFit Coaching', 'Olympic Lifting', 'Mobility Training', 'Competition Prep'],
    bookingDetails: {
      operationHours: '06:00 AM - 10:00 PM',
      membershipOption: 'Monthly/Drop-in Classes',
    },
    rules: ['Follow coach instructions', 'Respect equipment', 'No ego lifting', 'Support fellow members'],
    additionalFeatures: ['Competition Training', 'Community Events', 'Nutrition Guidance'],
    pricing: {
  ...
  },
  {
    ...
    gymDescription: 'Premium wellness studio offering yoga, meditation, and holistic health programs. Celebrity trainers and luxury amenities.',
    rating: 4.9,
    images: [
      {
        name: 'Yoga Studio',
    ...
    amenities: ['Luxury Amenities', 'Spa Services', 'Organic Cafe', 'Valet Parking', 'Concierge'],
    availableStatus: 'Available',
    availableFrom: new Date().toISOString(),
    ageOfGym: 5,
    gymEquipment: ['Yoga Mats', 'Meditation Cushions', 'Blocks', 'Straps', 'Bolsters'],
    facilities: ['Spa', 'Organic Cafe', 'Meditation Garden', 'Therapy Rooms', 'Relaxation Lounge'],
    trainerServices: ['Celebrity Yoga Instructors', 'Meditation Coaching', 'Wellness Consultation', 'Spa Treatments'],
    bookingDetails: {
      operationHours: '06:00 AM - 09:00 PM',
      membershipOption: 'Premium Packages/Private Sessions',
    },
    rules: ['Maintain silence in meditation areas', 'Organic lifestyle encouraged', 'Respect personal space'],
    additionalFeatures: ['Celebrity Trainers', 'Luxury Spa', 'Organic Nutrition', 'Wellness Retreats'],
    pricing: {
...
export const GymProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  const updateGym = async (id: string, gym: Partial<Gym>) => {
    setGyms(
      gyms.map((g) =>
        g.id === id
          ? { ...g, ...gym, updatedAt: new Date().toISOString() }
          : g
      )
    );
  };
